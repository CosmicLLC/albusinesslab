...
const localFit = [
  "Professional service firms — law, accounting, insurance, financial advisory — clustered downtown and in the Back Bay and Seaport.",
  "Healthcare practices and biotech-adjacent small businesses supporting the Longwood Medical Area and beyond.",
  "Restaurants, retail, and hospitality businesses across neighborhoods from the North End to Jamaica Plain and Dorchester.",
        ...
        <Container>
          <motion.div {...fadeUp} className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-7xl font-medium tracking-tighter mb-8">
              AI Consulting for Boston Small Businesses
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground font-light leading-relaxed mb-10">
              Boston has the highest concentration of small businesses anywhere in Massachusetts — and some of the
              stiffest competition for their customers' attention. AI Business Lab works with Boston-area small
              businesses from our Massachusetts base to close the gap between "using AI tools" and actually running
              on them.
            </p>
            <Button asChild size="lg" className="h-14 px-8 text-base rounded-xl">
              <Link href="/contact?subject=Boston%20AI%20Snapshot">Book a Free AI Readiness Snapshot</Link>
            </Button>
          </motion.div>
        </Container>
      </section>
          ...
          <motion.div {...fadeUp} className="max-w-3xl">
            ...
            <div className="prose prose-invert prose-p:text-muted-foreground prose-p:leading-relaxed prose-p:text-lg max-w-none">
              <p>
                ...
                and a one-page report on where AI would realistically help. From there, some Boston clients start
        ...
        <Container>
          <motion.div {...fadeUp} className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              Boston-based employers are eligible for the same Workforce Training Fund Program as any Massachusetts
              small business.
            </p>
